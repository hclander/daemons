...
TXS_PRJ_SOURCES=txs_prj.c frames.c frames.h framedecoder_list.c framedecoder_list.h lib/tools.c lib/tools.h lib/hashinttable.c lib/hashinttable.h lib/mem.c lib/mem.h
